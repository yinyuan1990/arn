...
contract SnipingTest is Base {
    ...
    function test_mev_sandwichAgainstKeeperMinOutFailsSafely() public {
        ...
        (uint256 usdcCollected, uint256 usdcFromToken) = distributeAndSync(token, minOut);
        ...
        assertEq(usdc.balanceOf(creator) - cU, (usdcCollected * 7_800) / 10_000, "USDC part still paid");
