...
contract TaxTest is Base {
    ...
    function test_tax_distributeSplitsTaxToMarketingAndTeam_feesStill75_25() public {
        ...
        uint256 creatorFromFees = (feeTotal * 7_800) / 10_000;
        assertEq(usdc.balanceOf(address(treasury)) - before[1], feeTotal - creatorFromFees, "protocol: 22% of fees, 0 of tax");
        assertEq(usdc.balanceOf(creator) - before[0], creatorFromFees, "creator payout: 78% of fees only; tax went to the tax wallets");
    }
